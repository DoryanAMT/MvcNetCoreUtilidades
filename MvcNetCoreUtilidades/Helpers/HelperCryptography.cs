...
namespace MvcNetCoreUtilidades.Helpers
{
    ...
    {
        //  TENDREMOS UN PROPIEDAD NUEVA PARA ALMACENAR EL
        ...
        private static string GenerateSalt()
        {
            ...
            for (int i = 1; i <= 50; i++)
            {
                //  GENERAMOS UN NUMERO ALEATORIO CON CODIGO ASCI
        ...
        public static string EncriptarTextoBasico
            (string contenido)
        {
            ...
            byte[] salida;
            //  NECESITAMOS UNA CLASE QUE NOS PERMITE CONVERITR DE
            ...
            //  ComputedHash QUE RECIBE UN ARRAY DE BYTES E
